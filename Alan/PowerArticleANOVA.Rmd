...
toc: FALSE
abstract: |
  **Summary** Understanding and computing power and the relationship between sample size and power are facilitated via a Shiny app which allows for a greater emphasis on interpretation of results.  The Shiny app allows students to solve various scenarios by entering different parameters or moving sliders.  
...
where $SS_\text{Hypothesis}(\text{population})$ is the sum of squares for  treatments 
...
```{r, echo = FALSE, label = power1, fig.cap = "Power to detect specified means with given sample sizes and population standard deviation"}
...
```{r, echo = FALSE, label = power2, fig.cap = "Power to detect specified means with given sample sizes and population standard deviation"}
...
```{r, echo = FALSE, label = power3, fig.cap = "Power to detect specified means with given sample sizes and population standard deviation"}
...
```{r, echo = FALSE, label = power4, fig.cap = "Power to detect specified means with given sample sizes and population standard deviation"}
