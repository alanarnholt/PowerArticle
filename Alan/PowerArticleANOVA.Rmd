...
d) Have the students use different values for $n_1 = n_2$ potentially starting with 12 and observing the computed power is more than sufficient. Lead the students through computing the power with a reduced sample sizes of $n_1 = n_2 = 9$ so that the critical value becomes $f_{1 - \alpha; a - 1, n_1 + n_2 -2} = f_{0.95; 2 - 1, 9 + 9 -2} = f_{0.95; 1, 16} = `r qf(0.95, 1, 16)`$ and the non-centrality parameter $\lambda$ becomes
