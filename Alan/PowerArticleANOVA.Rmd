...
\sum_{j=1}^{n_i}Y_{ij}=\frac{Y_{\bullet\bullet}}{N}.$

To describe the observations, the linear statistical model
\begin{equation}\label{EDMeq}
...
and constant standard deviation $\bigl(NID(0, \sigma)\bigr)$. 
