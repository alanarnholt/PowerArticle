...
CriticalF
# Power for lambda = 10.125
POWER <- pf(CriticalF, 2 - 1, 9 + 9 - 2, 10.125, lower = FALSE) 
POWER
# Computing critical value
CriticalF <- qf(0.95, 2 - 1, 8 + 8 - 2)
CriticalF
# Power for lambda = 9
POWER <- pf(CriticalF, 2 - 1, 8 + 8 - 2, 9, lower = FALSE)
POWER
```
...
CriticalF
# Power for lambda = 9.529412
POWER <- pf(CriticalF, 2 - 1, 9 + 8 - 2, 9.529412, lower = FALSE)
POWER
```
...
CriticalF
# Power for lambda
POWER <- pf(CriticalF, 2 - 1, 17 + 17 - 2, 8.5, lower = FALSE)
POWER
```
